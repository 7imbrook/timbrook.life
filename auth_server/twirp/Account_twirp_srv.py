...
class AuthImpl(object):
    def Login(self, login_request, ctx={}):
        raise TwirpServerException(Errors.Unimplemented,
                                   "Login is unimplemented")


class AuthServer(TwirpWSGIApp):
    def __init__(self, service):
        """Creates a new WSGI app for the Auth service.

        Args:
            service: An object with methods matching the protocol of
                AuthImpl, which implements the service logic.
        """
        self.service = service

        self._package_name = "twirp"
        self._service_name = "twirp.Auth"
        ...
        self._endpoints = {
            "Login": Endpoint(
                ...
                input=_sym_lookup("twirp.LoginRequest"),
                output=_sym_lookup("twirp.Account"),
            ),
        }
